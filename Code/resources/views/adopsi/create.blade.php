...
<div class="max-w-5xl mx-auto py-8 px-4">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <h1 class="text-3xl font-bold text-blue-900">Tambah Adopsi</h1>
            <p class="text-sm text-gray-600">Isi data pemohon, hewan, dan tanggal adopsi.</p>
        </div>
    ...
    <form action="{{ route('admin.adopsi.store') }}" method="POST" class="bg-white p-6 rounded-2xl shadow border border-gray-100 space-y-4">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="date" name="tanggal_adopsi" value="{{ old('tanggal_adopsi') }}" class="mt-1 block w-full border-2 border-blue-200 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none bg-white text-blue-900 font-semibold" required>
